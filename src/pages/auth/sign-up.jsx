...
export function SignUp() {
  ...
  //     // Jika pengguna sudah login, arahkan ke dashboard atau halaman lainnya
  ...
  const [email, setEmail] = useState('');
    ...
    const handleSignUp = async (event) => {
      ...
      if (success) {
        ...
        setError('Invalid email or password'); // Reset pesan kesalahan sebelum menetapkannya
      }
      }catch{
    ...
    <section className="m-8 flex">
      ...
      <div className="w-full lg:w-3/5 flex flex-col items-center justify-center">
        ...
        <form onSubmit={handleSignUp} className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          ...
          <div className="mb-1 flex flex-col gap-6">
            <Typography variant="small" color="blue-gray" className="-mb-3 mt-3 font-medium">
              Your email
            </Typography>
            <Input
              size="lg"
          ...
          {loginUrl != null && (
            <Button onClick={redirectToLogin} size="lg" color="white" className="flex items-center gap-2 justify-center shadow-md" fullWidth>
